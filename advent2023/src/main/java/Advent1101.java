...
class Advent1101 {
    public static void main(String[] args) {
        ...
        Map<Set<Galaxy>, Integer> galaxiesPairsDistances = getGalaxiesPairsDistances(galaxiesPairs, spaceMap);
        System.out.println("Distances: " + galaxiesPairsDistances.entrySet());
        int sum = galaxiesPairsDistances.values().stream().reduce(0, Integer::sum);
    ...
    private static Map<Set<Galaxy>, Integer> getGalaxiesPairsDistances(Set<Set<Galaxy>> galaxiesPairs, Map<Coordinate, Content> spaceMap) {
        Map<Set<Galaxy>, Integer> galaxiesPairsDistances = new HashMap<>();
        for (Set<Galaxy> galaxiesPair : galaxiesPairs) {
            Map.Entry<Set<Galaxy>, Integer> galaxiesPairsDistance = getGalaxiesPairDistance(galaxiesPair, spaceMap);
            galaxiesPairsDistances.put(galaxiesPairsDistance.getKey(), galaxiesPairsDistance.getValue());
        }
        return galaxiesPairsDistances;
    }

    private static Map.Entry<Set<Galaxy>, Integer> getGalaxiesPairDistance(Set<Galaxy> galaxiesPair, Map<Coordinate, Content> spaceMap) {
